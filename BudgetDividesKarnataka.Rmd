---
title: "Sentiment Analysis on Budget Divides Karnataka"
author: "Sushmitha K"
date: "July 10, 2018"
...
kar_budget = searchTwitter("#BudgetDividesKarnataka", n = 2000,lang = "en") 
```
...
kar_budget = twListToDF(kar_budget)


#Saving the dataset into a csv file

write.csv(kar_budget,"E:/Extra/Twitter/Data Sets/kar_budget.csv")
```
...
tab3 %>% head(10) %>%  ggplot(aes(x = reorder(words,Freq),y = Freq))+geom_bar(stat = "identity",fill="navyblue")+xlab("Words")+theme_bw()+coord_flip()


#wordcloud

wordcloud (words=tab3$words,freq=tab3$Freq,min.freq=8,max.words=80, colors=brewer.pal(8, "Dark2"))
...
# Number of Positive Reactions on Budget Divides Karnataka
sum(scores_df$score > 0)


# Number of Negative Reactions on Budget Divides Karnataka
sum(scores_df$score < 0)


# Neutral reactions on Budget Divides Karnataka
sum(scores_df$score == 0)


# Distribution of positive,negative and neutral words
